...
pdf("../Alternative EC/googletrends.pdf", width=8, height=4)
par(mfrow=c(1,1),
	mar=c(3,3,.25,.25))
...
axis(side=1, at= c(1, 13, 25, 37, 49, 61, 73, 85, 97, 109, 121, 133, 145, 157, 169), labels=seq(2004,2018, 1), cex.axis=0.65, padj=-1, tcl=-0.2)
